...
<c:set var="boardList1" value="${map.boardList}" />
  ...
  <div class="board-view-modal" id="boardViewModal">
    <div class="board-view-area">
      ...
      <div class="board-view-content-all">
        ...
        <div class="board-view-title-detail-answer" id="boardViewTitleDetailAnswerImg">
          ...
          <div class="board-view-content-img-area" id="ContentImgArea">
        ...
        <div class="board-view-title-detail-answer">
          <div class="board-view-content-detail-answer">
            <div class="board-view-content-content" id="boardViewContentContentComment">
              <%-- <p>답변</p> --%>
              <%-- <p>2022.12.15</p> --%>
            </div>
        ...
        <div class="board-view-content-delete-update" id="${loginMember.memberId}">
          <div class="board-view-btn" id="boardDelete">
            삭제
          </div>
