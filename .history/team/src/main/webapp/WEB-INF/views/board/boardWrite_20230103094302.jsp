...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  ...
  <form action="/QAWrite/4" method="POST" enctype="multipart/form-data" id="postForm" name="postForm" onsubmit="return writeValidate()">
    <div class="board-view-area">
      ...
      <div class="board-view-content-all">
        <div class="board-view-title-detail-answer">
          <!-- <p>[ </p> -->
          <textarea id="boardTitle" name="boardTitle" type="text" placeholder="작성할 제목을 입력해주세요.(20자내외)" maxlength='5'></textarea>
          <!-- <p> ]</p> -->
      </div>
