              ...
              <c:otherwise>
                <c:forEach var="board" items="${boardList}">
                  <tr class="board-list-view">
                    ...
                    <p>whghltn lkasdjf;lakjsdf;lk${board.readCount}${board.readCount}${board.readCount}${board.readCount}</p>
                ...
                <c:choose>
                  ...
                  <c:otherwise>
                    ...
                    <c:choose>
                      ...
                      <c:when test="${not empty param.query}">
                        <li class="board-list-page-no"><a class="aaa" href="/boardList/${boardCode}?cp=${i}&key=${param.key}&query=${param.query}">${i}</a></li>
                      </c:when>
                      <c:otherwise>
