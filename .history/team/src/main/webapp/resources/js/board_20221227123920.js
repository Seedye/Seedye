...
// 파일 선택
const inputAddFile1 = document.getElementById("inputAddFile1"); // 추가로 파일 선택
const inputAddFile2 = document.getElementById("inputAddFile2"); // 추가로 파일 선택
const inputAddFile3 = document.getElementById("inputAddFile3"); // 추가로 파일 선택
...
inputFile.addEventListener("change", (e)=>{
  ...
  if(e.target.files[0] != undefined){
    ...
    switch(filesLength){
      case 1:
        inputFile.classList.remove("add-file-area-hidden");
        inputFile.classList.add("add-file-area");
      case 2:
        inputFile2.classList.remove("add-file-area-hidden");
        inputFile2.classList.add("add-file-area");
      case 3:
        inputFile3.classList.remove("add-file-area-hidden");
        inputFile3.classList.add("add-file-area");
      default:
        inputAddFile.classList.remove("add-file-area");
        inputFile2.classList.add("add-file-area-hidden");
        inputFile3.classList.add("add-file-area-hidden");
        inputFile3.classList.add("add-file-area-hidden");
        inputFile3.classList.add("add-file-area-hidden");
