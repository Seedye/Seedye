  ...
  if(e.target.files[0] != undefined){
    ...
    for(let i=0; i < fileInputNum; i++){
      ...
      reader.onload = (e) => {
        ...
        //   <img src="../../resources/images/게시판테스트img1.jpg" alt="" class="inputImgs">
        //   <input type=hidden name='inputFile[]' value='이미지경로'  class='tmp1'>");
        // </div>
        ...
        fileImg.classList.add("inputImgs");

        imgInput.setAttribute("type", "hidden");
        imgInput.setAttribute("name", "inputFile[]");
        imgInput.setAttribute("value", e.target.result);
        imgInput.classList.add("inputImgs");

        // fileImg.setAttribute("name", "inputFile" );
