...
inputFile.addEventListener("change", (e)=>{
  ...
  if(e.target.files[0] != undefined){
    ...
    if(filesLength <4){
      ...
      //     </div> 
      //   </label>
      // <input type="file" id="addInputFile" multiple="multiple" hidden>           
      ...
      // addFileHiddenInput.setAttribute("hidden");
      
      // addInputFileLabel.append(ImgAddI);
      // ImgDeleteDiv.append(addInputFileLabel,addFileHiddenInput);
