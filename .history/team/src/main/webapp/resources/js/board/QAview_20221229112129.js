  ...
  boardListViewItems.addEventListener("click", ()=>{
    ...
    $.ajax({
      ...
      success : (QABoardDetail)=>{
        ...
        //! 이미지 만드는 create작성해야함.
        // if(QABoardDetail[0].imgNo != null){
        //   boardViewContentImgArea.style.display="flex";
        ...
        //   contentImgImg.setAttribute("src", QABoardDetail[0].imgPath+QABoardDetail[0].imgRename);
