          ...
          boardItems.lastElementChild.lastElementChild.addEventListener("click", (e)=>{
            ...
            $.ajax({
              ...
              success:(map)=>{
                ...
                const boardModalWriter = document.getElementById("boardModalWriter");
                const boardModalDate = document.getElementById("boardModalDate");
                ...
                boardModalDate.innerText = boardList[0].createDate;

                
                let textTemp;
            
                textTemp = boardList[0].boardContent;
